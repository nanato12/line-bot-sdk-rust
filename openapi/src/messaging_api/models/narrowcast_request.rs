...
pub struct NarrowcastRequest {
    ...
    pub recipient: Option<Box<crate::messaging_api::models::Recipient>>,
    #[serde(rename = "filter", skip_serializing_if = "Option::is_none")]
    pub filter: Option<Box<crate::messaging_api::models::Filter>>,
    #[serde(rename = "limit", skip_serializing_if = "Option::is_none")]
    pub limit: Option<Box<crate::messaging_api::models::Limit>>,
...
impl NarrowcastRequest {
    pub fn new(messages: Vec<crate::messaging_api::models::Message>) -> NarrowcastRequest {
        NarrowcastRequest {
            messages,
            recipient: None,
            filter: None,
