...
pub struct FlexMessage {
    ...
    pub contents: Box<crate::messaging_api::models::FlexContainer>,
}

impl FlexMessage {
    pub fn new(r#type: String, alt_text: String, contents: crate::messaging_api::models::FlexContainer) -> FlexMessage {
        FlexMessage {
            r#type,
            quick_reply: None,
            sender: None,
