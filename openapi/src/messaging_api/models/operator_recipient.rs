...
pub struct OperatorRecipient {
    ...
    pub and: Option<Vec<crate::messaging_api::models::Recipient>>,
    ...
    pub or: Option<Vec<crate::messaging_api::models::Recipient>>,
    #[serde(rename = "not", skip_serializing_if = "Option::is_none")]
    pub not: Option<Box<crate::messaging_api::models::Recipient>>,
}
