...
pub struct RichMenuBatchRequest {
    ...
    pub operations: Vec<crate::messaging_api::models::RichMenuBatchOperation>,
...
impl RichMenuBatchRequest {
    pub fn new(operations: Vec<crate::messaging_api::models::RichMenuBatchOperation>) -> RichMenuBatchRequest {
