...
pub async fn acquire_chat_control(configuration: &configuration::Configuration, params: AcquireChatControlParams) -> Result<(), Error<AcquireChatControlError>> {
    ...
    let local_var_uri_str = format!("{}/v2/bot/chat/{chatId}/control/acquire", local_var_configuration.base_path, chatId=crate::module::apis::urlencode(chat_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AcquireChatControlError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn detach_module(configuration: &configuration::Configuration, params: DetachModuleParams) -> Result<(), Error<DetachModuleError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v2/bot/channel/detach", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DetachModuleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_modules(configuration: &configuration::Configuration, params: GetModulesParams) -> Result<crate::module::models::GetModulesResponse, Error<GetModulesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetModulesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn release_chat_control(configuration: &configuration::Configuration, params: ReleaseChatControlParams) -> Result<(), Error<ReleaseChatControlError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v2/bot/chat/{chatId}/control/release", local_var_configuration.base_path, chatId=crate::module::apis::urlencode(chat_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReleaseChatControlError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
