...
pub struct AudienceGroup {
    ...
    pub failed_type: Option<Option<crate::manage_audience::models::AudienceGroupFailedType>>,
    ...
    pub permission: Option<crate::manage_audience::models::AudienceGroupPermission>,
