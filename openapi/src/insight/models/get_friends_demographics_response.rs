...
pub struct GetFriendsDemographicsResponse {
    ...
    pub genders: Option<Vec<crate::insight::models::GenderTile>>,
    /// Percentage per age group.
    #[serde(rename = "ages", skip_serializing_if = "Option::is_none")]
    pub ages: Option<Vec<crate::insight::models::AgeTile>>,
    /// Percentage per area.
    #[serde(rename = "areas", skip_serializing_if = "Option::is_none")]
    pub areas: Option<Vec<crate::insight::models::AreaTile>>,
    /// Percentage by OS.
    #[serde(rename = "appTypes", skip_serializing_if = "Option::is_none")]
    pub app_types: Option<Vec<crate::insight::models::AppTypeTile>>,
    /// Percentage per friendship duration.
    #[serde(
        rename = "subscriptionPeriods",
        skip_serializing_if = "Option::is_none"
    )]
    pub subscription_periods: Option<Vec<crate::insight::models::SubscriptionPeriodTile>>,
}
