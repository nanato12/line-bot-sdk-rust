...
pub async fn get_friends_demographics(configuration: &configuration::Configuration) -> Result<crate::insight::models::GetFriendsDemographicsResponse, Error<GetFriendsDemographicsError>> {
    ...
    let local_var_uri_str = format!("{}/v2/bot/insight/demographic", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFriendsDemographicsError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_message_event(configuration: &configuration::Configuration, params: GetMessageEventParams) -> Result<crate::insight::models::GetMessageEventResponse, Error<GetMessageEventError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v2/bot/insight/message/event", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMessageEventError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_number_of_followers(configuration: &configuration::Configuration, params: GetNumberOfFollowersParams) -> Result<crate::insight::models::GetNumberOfFollowersResponse, Error<GetNumberOfFollowersError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v2/bot/insight/followers", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetNumberOfFollowersError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_number_of_message_deliveries(configuration: &configuration::Configuration, params: GetNumberOfMessageDeliveriesParams) -> Result<crate::insight::models::GetNumberOfMessageDeliveriesResponse, Error<GetNumberOfMessageDeliveriesError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v2/bot/insight/message/delivery", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetNumberOfMessageDeliveriesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_statistics_per_unit(configuration: &configuration::Configuration, params: GetStatisticsPerUnitParams) -> Result<crate::insight::models::GetStatisticsPerUnitResponse, Error<GetStatisticsPerUnitError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v2/bot/insight/message/event/aggregation", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

    local_var_req_builder = local_var_req_builder.query(&[("customAggregationUnit", &custom_aggregation_unit.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetStatisticsPerUnitError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
