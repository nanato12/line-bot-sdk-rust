...
pub async fn mission_sticker_v3(configuration: &configuration::Configuration, params: MissionStickerV3Params) -> Result<(), Error<MissionStickerV3Error>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MissionStickerV3Error> = serde_json::from_str(&local_var_content).ok();
