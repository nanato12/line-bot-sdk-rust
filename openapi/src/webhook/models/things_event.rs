...
pub struct ThingsEvent {
    ...
    #[serde(rename = "things")]
    pub things: Box<crate::webhook::models::ThingsContent>,
}

impl ThingsEvent {
    /// Indicates that a user linked a device with LINE.
    pub fn new(r#type: String, timestamp: i64, mode: crate::webhook::models::EventMode, webhook_event_id: String, delivery_context: crate::webhook::models::DeliveryContext, reply_token: String, things: crate::webhook::models::ThingsContent) -> ThingsEvent {
        ThingsEvent {
            r#type,
            source: None,
            timestamp,
