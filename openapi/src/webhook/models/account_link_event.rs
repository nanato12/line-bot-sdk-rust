...
pub struct AccountLinkEvent {
    ...
    #[serde(rename = "link")]
    pub link: Box<crate::webhook::models::LinkContent>,
}
...
impl AccountLinkEvent {
    ...
    pub fn new(r#type: String, timestamp: i64, mode: crate::webhook::models::EventMode, webhook_event_id: String, delivery_context: crate::webhook::models::DeliveryContext, link: crate::webhook::models::LinkContent) -> AccountLinkEvent {
        AccountLinkEvent {
            r#type,
            source: None,
            timestamp,
