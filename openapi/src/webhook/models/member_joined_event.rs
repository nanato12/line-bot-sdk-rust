...
pub struct MemberJoinedEvent {
    ...
    #[serde(rename = "joined")]
    pub joined: Box<crate::webhook::models::JoinedMembers>,
}
...
impl MemberJoinedEvent {
    ...
    pub fn new(r#type: String, timestamp: i64, mode: crate::webhook::models::EventMode, webhook_event_id: String, delivery_context: crate::webhook::models::DeliveryContext, reply_token: String, joined: crate::webhook::models::JoinedMembers) -> MemberJoinedEvent {
        MemberJoinedEvent {
            r#type,
            source: None,
            timestamp,
