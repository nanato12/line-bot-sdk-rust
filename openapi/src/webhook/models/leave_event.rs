...
impl LeaveEvent {
    ...
    pub fn new(r#type: String, timestamp: i64, mode: crate::webhook::models::EventMode, webhook_event_id: String, delivery_context: crate::webhook::models::DeliveryContext) -> LeaveEvent {
        LeaveEvent {
            r#type,
            source: None,
            timestamp,
