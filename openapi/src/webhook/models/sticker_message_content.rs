...
impl StickerMessageContent {
    pub fn new(r#type: String, id: String, package_id: String, sticker_id: String, sticker_resource_type: StickerResourceTypeWebhook, quote_token: String) -> StickerMessageContent {
