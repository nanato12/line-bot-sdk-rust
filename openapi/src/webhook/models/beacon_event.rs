...
pub struct BeaconEvent {
    ...
    #[serde(rename = "beacon")]
    pub beacon: Box<crate::webhook::models::BeaconContent>,
}

impl BeaconEvent {
    /// Event object for when a user enters the range of a LINE Beacon. You can reply to beacon events.
    pub fn new(r#type: String, timestamp: i64, mode: crate::webhook::models::EventMode, webhook_event_id: String, delivery_context: crate::webhook::models::DeliveryContext, reply_token: String, beacon: crate::webhook::models::BeaconContent) -> BeaconEvent {
        BeaconEvent {
            r#type,
            source: None,
            timestamp,
