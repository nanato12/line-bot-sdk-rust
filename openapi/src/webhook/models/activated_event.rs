...
pub struct ActivatedEvent {
    ...
    pub chat_control: Box<crate::webhook::models::ChatControl>,
}
...
impl ActivatedEvent {
    ...
    pub fn new(r#type: String, timestamp: i64, mode: crate::webhook::models::EventMode, webhook_event_id: String, delivery_context: crate::webhook::models::DeliveryContext, chat_control: crate::webhook::models::ChatControl) -> ActivatedEvent {
        ActivatedEvent {
            r#type,
            source: None,
            timestamp,
