...
pub struct MemberLeftEvent {
    ...
    #[serde(rename = "left")]
    pub left: Box<crate::webhook::models::LeftMembers>,
}
...
impl MemberLeftEvent {
    ...
    pub fn new(r#type: String, timestamp: i64, mode: crate::webhook::models::EventMode, webhook_event_id: String, delivery_context: crate::webhook::models::DeliveryContext, left: crate::webhook::models::LeftMembers) -> MemberLeftEvent {
        MemberLeftEvent {
            r#type,
            source: None,
            timestamp,
