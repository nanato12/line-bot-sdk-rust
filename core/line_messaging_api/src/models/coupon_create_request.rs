...
pub struct CouponCreateRequest {
    ...
    pub acquisition_condition: Box<crate::models::AcquisitionConditionRequest>,
    ...
    pub reward: Option<Box<crate::models::CouponRewardRequest>>,
...
impl CouponCreateRequest {
    ...
    pub fn new(
        acquisition_condition: crate::models::AcquisitionConditionRequest,
        end_timestamp: i64,
