...
pub trait MessagingApiApi {
    fn audience_match(&self, audience_match_messages_request: crate::models::AudienceMatchMessagesRequest) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn broadcast(&self, broadcast_request: crate::models::BroadcastRequest, x_line_retry_key: Option<&str>) -> Pin<Box<dyn Future<Output = Result<serde_json::Value, Error>>>>;
    fn cancel_default_rich_menu(&self, ) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn create_rich_menu(&self, rich_menu_request: crate::models::RichMenuRequest) -> Pin<Box<dyn Future<Output = Result<crate::models::RichMenuIdResponse, Error>>>>;
    fn create_rich_menu_alias(&self, create_rich_menu_alias_request: crate::models::CreateRichMenuAliasRequest) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn delete_rich_menu(&self, rich_menu_id: &str) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn delete_rich_menu_alias(&self, rich_menu_alias_id: &str) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn get_ad_phone_message_statistics(&self, date: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::NumberOfMessagesResponse, Error>>>>;
    fn get_aggregation_unit_name_list(&self, limit: Option<&str>, start: Option<&str>) -> Pin<Box<dyn Future<Output = Result<crate::models::GetAggregationUnitNameListResponse, Error>>>>;
    fn get_aggregation_unit_usage(&self, ) -> Pin<Box<dyn Future<Output = Result<crate::models::GetAggregationUnitUsageResponse, Error>>>>;
    fn get_bot_info(&self, ) -> Pin<Box<dyn Future<Output = Result<crate::models::BotInfoResponse, Error>>>>;
    fn get_default_rich_menu_id(&self, ) -> Pin<Box<dyn Future<Output = Result<crate::models::RichMenuIdResponse, Error>>>>;
    fn get_followers(&self, start: Option<&str>, limit: Option<i32>) -> Pin<Box<dyn Future<Output = Result<crate::models::GetFollowersResponse, Error>>>>;
    fn get_group_member_count(&self, group_id: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::GroupMemberCountResponse, Error>>>>;
    fn get_group_member_profile(&self, group_id: &str, user_id: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::GroupUserProfileResponse, Error>>>>;
    fn get_group_members_ids(&self, group_id: &str, start: Option<&str>) -> Pin<Box<dyn Future<Output = Result<crate::models::MembersIdsResponse, Error>>>>;
    fn get_group_summary(&self, group_id: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::GroupSummaryResponse, Error>>>>;
    fn get_message_quota(&self, ) -> Pin<Box<dyn Future<Output = Result<crate::models::MessageQuotaResponse, Error>>>>;
    fn get_message_quota_consumption(&self, ) -> Pin<Box<dyn Future<Output = Result<crate::models::QuotaConsumptionResponse, Error>>>>;
    fn get_narrowcast_progress(&self, request_id: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::NarrowcastProgressResponse, Error>>>>;
    fn get_number_of_sent_broadcast_messages(&self, date: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::NumberOfMessagesResponse, Error>>>>;
    fn get_number_of_sent_multicast_messages(&self, date: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::NumberOfMessagesResponse, Error>>>>;
    fn get_number_of_sent_push_messages(&self, date: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::NumberOfMessagesResponse, Error>>>>;
    fn get_number_of_sent_reply_messages(&self, date: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::NumberOfMessagesResponse, Error>>>>;
    fn get_pnp_message_statistics(&self, date: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::NumberOfMessagesResponse, Error>>>>;
    fn get_profile(&self, user_id: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::UserProfileResponse, Error>>>>;
    fn get_rich_menu(&self, rich_menu_id: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::RichMenuResponse, Error>>>>;
    fn get_rich_menu_alias(&self, rich_menu_alias_id: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::RichMenuAliasResponse, Error>>>>;
    fn get_rich_menu_alias_list(&self, ) -> Pin<Box<dyn Future<Output = Result<crate::models::RichMenuAliasListResponse, Error>>>>;
    fn get_rich_menu_batch_progress(&self, request_id: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::RichMenuBatchProgressResponse, Error>>>>;
    fn get_rich_menu_id_of_user(&self, user_id: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::RichMenuIdResponse, Error>>>>;
    fn get_rich_menu_list(&self, ) -> Pin<Box<dyn Future<Output = Result<crate::models::RichMenuListResponse, Error>>>>;
    fn get_room_member_count(&self, room_id: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::RoomMemberCountResponse, Error>>>>;
    fn get_room_member_profile(&self, room_id: &str, user_id: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::RoomUserProfileResponse, Error>>>>;
    fn get_room_members_ids(&self, room_id: &str, start: Option<&str>) -> Pin<Box<dyn Future<Output = Result<crate::models::MembersIdsResponse, Error>>>>;
    fn get_webhook_endpoint(&self, ) -> Pin<Box<dyn Future<Output = Result<crate::models::GetWebhookEndpointResponse, Error>>>>;
    fn issue_link_token(&self, user_id: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::IssueLinkTokenResponse, Error>>>>;
    ...
    fn link_rich_menu_id_to_user(&self, user_id: &str, rich_menu_id: &str) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn link_rich_menu_id_to_users(&self, rich_menu_bulk_link_request: crate::models::RichMenuBulkLinkRequest) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn mark_messages_as_read(&self, mark_messages_as_read_request: crate::models::MarkMessagesAsReadRequest) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn multicast(&self, multicast_request: crate::models::MulticastRequest, x_line_retry_key: Option<&str>) -> Pin<Box<dyn Future<Output = Result<serde_json::Value, Error>>>>;
    fn narrowcast(&self, narrowcast_request: crate::models::NarrowcastRequest, x_line_retry_key: Option<&str>) -> Pin<Box<dyn Future<Output = Result<serde_json::Value, Error>>>>;
    fn push_message(&self, push_message_request: crate::models::PushMessageRequest, x_line_retry_key: Option<&str>) -> Pin<Box<dyn Future<Output = Result<crate::models::PushMessageResponse, Error>>>>;
    fn push_messages_by_phone(&self, pnp_messages_request: crate::models::PnpMessagesRequest, x_line_delivery_tag: Option<&str>) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn reply_message(&self, reply_message_request: crate::models::ReplyMessageRequest) -> Pin<Box<dyn Future<Output = Result<crate::models::ReplyMessageResponse, Error>>>>;
    fn rich_menu_batch(&self, rich_menu_batch_request: crate::models::RichMenuBatchRequest) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn set_default_rich_menu(&self, rich_menu_id: &str) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn set_webhook_endpoint(&self, set_webhook_endpoint_request: crate::models::SetWebhookEndpointRequest) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn test_webhook_endpoint(&self, test_webhook_endpoint_request: Option<crate::models::TestWebhookEndpointRequest>) -> Pin<Box<dyn Future<Output = Result<crate::models::TestWebhookEndpointResponse, Error>>>>;
    fn unlink_rich_menu_id_from_user(&self, user_id: &str) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn unlink_rich_menu_id_from_users(&self, rich_menu_bulk_unlink_request: crate::models::RichMenuBulkUnlinkRequest) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn update_rich_menu_alias(&self, rich_menu_alias_id: &str, update_rich_menu_alias_request: crate::models::UpdateRichMenuAliasRequest) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn validate_broadcast(&self, validate_message_request: crate::models::ValidateMessageRequest) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn validate_multicast(&self, validate_message_request: crate::models::ValidateMessageRequest) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn validate_narrowcast(&self, validate_message_request: crate::models::ValidateMessageRequest) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn validate_push(&self, validate_message_request: crate::models::ValidateMessageRequest) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn validate_reply(&self, validate_message_request: crate::models::ValidateMessageRequest) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn validate_rich_menu_batch_request(&self, rich_menu_batch_request: crate::models::RichMenuBatchRequest) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn validate_rich_menu_object(&self, rich_menu_request: crate::models::RichMenuRequest) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
}
...
impl<C: hyper::client::connect::Connect>MessagingApiApi for MessagingApiApiClient<C>
    ...
    #[allow(unused_mut)]
    fn audience_match(&self, audience_match_messages_request: crate::models::AudienceMatchMessagesRequest) -> Pin<Box<dyn Future<Output = Result<(), Error>>>> {
        let mut req = __internal_request::Request::new(hyper::Method::POST, "/bot/ad/multicast/phone".to_string())
        ;
    ...
    #[allow(unused_mut)]
    fn get_ad_phone_message_statistics(&self, date: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::NumberOfMessagesResponse, Error>>>> {
        let mut req = __internal_request::Request::new(hyper::Method::GET, "/v2/bot/message/delivery/ad_phone".to_string())
        ;
