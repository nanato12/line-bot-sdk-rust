...
limit: Option<&str>,
start: Option<&str>,
) -> Pin<Box<dyn Future<Output = Result<models::GetAggregationUnitNameListResponse, Error>> + Send>>;
...
fn get_membership_subscription(
        &self,
user_id: &str,
) -> Pin<Box<dyn Future<Output = Result<models::GetMembershipSubscriptionResponse, Error>> + Send>>;
...
start: Option<&str>,
limit: Option<i32>,
) -> Pin<Box<dyn Future<Output = Result<models::MessagingApiPagerCouponListResponse, Error>> + Send>>;
...
coupon_id: &str,
        ...
        let mut req = __internal_request::Request::new(hyper::Method::PUT, "/v2/bot/coupon/{couponId}/close".to_string())
;
...
coupon_create_request: Option<models::CouponCreateRequest>,
        ...
        let mut req = __internal_request::Request::new(hyper::Method::POST, "/v2/bot/coupon".to_string())
;
...
coupon_id: &str,
        ...
        let mut req = __internal_request::Request::new(hyper::Method::GET, "/v2/bot/coupon/{couponId}".to_string())
;
req = req.with_path_param("couponId".to_string(), coupon_id.to_string());
...
limit: Option<i32>,
        ...
        let mut req = __internal_request::Request::new(hyper::Method::GET, "/v2/bot/coupon".to_string())
;
if let Some(ref s) = status {
let query_params = s.iter().map(|p| ("status".to_owned(), p.to_string())).collect::<Vec<(String, String)>>();
...
mark_messages_as_read_by_token_request: models::MarkMessagesAsReadByTokenRequest,
        ...
        let mut req = __internal_request::Request::new(hyper::Method::POST, "/v2/bot/chat/markAsRead".to_string())
;
