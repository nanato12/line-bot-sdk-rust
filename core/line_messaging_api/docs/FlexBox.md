...
------------ | ------------- | ------------- | -------------
**r#type** | **String** |  | 
**layout** | **Layout** |  (enum: horizontal, vertical, baseline) | 
...
**justify_content** | Option<**JustifyContent**> |  (enum: center, flex-start, flex-end, space-between, space-around, space-evenly) | [optional]
**align_items** | Option<**AlignItems**> |  (enum: center, flex-start, flex-end) | [optional]
