...
pub trait LineModuleAttachApi {
    fn attach_module(&self, grant_type: Option<&str>, code: Option<&str>, redirect_uri: Option<&str>, code_verifier: Option<&str>, client_id: Option<&str>, client_secret: Option<&str>, region: Option<&str>, basic_search_id: Option<&str>, scope: Option<&str>, brand_type: Option<&str>) -> Pin<Box<dyn Future<Output = Result<crate::models::AttachModuleResponse, Error>>>>;
}
