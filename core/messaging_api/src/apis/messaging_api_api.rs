...
pub struct AudienceMatchParams {
    pub audience_match_messages_request: crate::models::AudienceMatchMessagesRequest,
}

/// struct for passing parameters to the method [`broadcast`]
#[derive(Clone, Debug)]
pub struct BroadcastParams {
    pub broadcast_request: crate::models::BroadcastRequest,
...
pub struct CreateRichMenuParams {
    pub rich_menu_request: crate::models::RichMenuRequest,
}

/// struct for passing parameters to the method [`create_rich_menu_alias`]
#[derive(Clone, Debug)]
pub struct CreateRichMenuAliasParams {
    pub create_rich_menu_alias_request: crate::models::CreateRichMenuAliasRequest,
}
...
pub struct LinkRichMenuIdToUsersParams {
    pub rich_menu_bulk_link_request: crate::models::RichMenuBulkLinkRequest,
}

/// struct for passing parameters to the method [`mark_messages_as_read`]
#[derive(Clone, Debug)]
pub struct MarkMessagesAsReadParams {
    pub mark_messages_as_read_request: crate::models::MarkMessagesAsReadRequest,
}

/// struct for passing parameters to the method [`multicast`]
#[derive(Clone, Debug)]
pub struct MulticastParams {
    pub multicast_request: crate::models::MulticastRequest,
    /// Retry key. Specifies the UUID in hexadecimal format (e.g., `123e4567-e89b-12d3-a456-426614174000`) generated by any method. The retry key isn't generated by LINE. Each developer must generate their own retry key.
    pub x_line_retry_key: Option<String>,
}
...
pub struct NarrowcastParams {
    pub narrowcast_request: crate::models::NarrowcastRequest,
    /// Retry key. Specifies the UUID in hexadecimal format (e.g., `123e4567-e89b-12d3-a456-426614174000`) generated by any method. The retry key isn't generated by LINE. Each developer must generate their own retry key.
    pub x_line_retry_key: Option<String>,
}
...
pub struct PushMessageParams {
    pub push_message_request: crate::models::PushMessageRequest,
    /// Retry key. Specifies the UUID in hexadecimal format (e.g., `123e4567-e89b-12d3-a456-426614174000`) generated by any method. The retry key isn't generated by LINE. Each developer must generate their own retry key.
    pub x_line_retry_key: Option<String>,
}
...
pub struct PushMessagesByPhoneParams {
    pub pnp_messages_request: crate::models::PnpMessagesRequest,
...
pub struct ReplyMessageParams {
    pub reply_message_request: crate::models::ReplyMessageRequest,
}

/// struct for passing parameters to the method [`rich_menu_batch`]
#[derive(Clone, Debug)]
pub struct RichMenuBatchParams {
    pub rich_menu_batch_request: crate::models::RichMenuBatchRequest,
}
...
pub struct SetWebhookEndpointParams {
    pub set_webhook_endpoint_request: crate::models::SetWebhookEndpointRequest,
}

/// struct for passing parameters to the method [`test_webhook_endpoint`]
#[derive(Clone, Debug)]
pub struct TestWebhookEndpointParams {
    pub test_webhook_endpoint_request: Option<crate::models::TestWebhookEndpointRequest>,
}
...
pub struct UnlinkRichMenuIdFromUsersParams {
    pub rich_menu_bulk_unlink_request: crate::models::RichMenuBulkUnlinkRequest,
}
...
pub struct UpdateRichMenuAliasParams {
    ...
    pub rich_menu_alias_id: String,
    pub update_rich_menu_alias_request: crate::models::UpdateRichMenuAliasRequest,
}

/// struct for passing parameters to the method [`validate_broadcast`]
#[derive(Clone, Debug)]
pub struct ValidateBroadcastParams {
    pub validate_message_request: crate::models::ValidateMessageRequest,
}
...
pub enum CreateRichMenuSuccess {
    Status200(crate::models::RichMenuIdResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetAdPhoneMessageStatisticsSuccess {
    Status200(crate::models::NumberOfMessagesResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetAggregationUnitNameListSuccess {
    Status200(crate::models::GetAggregationUnitNameListResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetAggregationUnitUsageSuccess {
    Status200(crate::models::GetAggregationUnitUsageResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetBotInfoSuccess {
    Status200(crate::models::BotInfoResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetFollowersSuccess {
    Status200(crate::models::GetFollowersResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetGroupMemberCountSuccess {
    Status200(crate::models::GroupMemberCountResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetGroupMemberProfileSuccess {
    Status200(crate::models::GroupUserProfileResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetGroupMembersIdsSuccess {
    Status200(crate::models::MembersIdsResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetGroupSummarySuccess {
    Status200(crate::models::GroupSummaryResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetMessageQuotaSuccess {
    Status200(crate::models::MessageQuotaResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetMessageQuotaConsumptionSuccess {
    Status200(crate::models::QuotaConsumptionResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetNarrowcastProgressSuccess {
    Status200(crate::models::NarrowcastProgressResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetProfileSuccess {
    Status200(crate::models::UserProfileResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetRichMenuSuccess {
    Status200(crate::models::RichMenuResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetRichMenuAliasSuccess {
    Status200(crate::models::RichMenuAliasResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetRichMenuAliasListSuccess {
    Status200(crate::models::RichMenuAliasListResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetRichMenuBatchProgressSuccess {
    Status200(crate::models::RichMenuBatchProgressResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetRichMenuListSuccess {
    Status200(crate::models::RichMenuListResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetRoomMemberCountSuccess {
    Status200(crate::models::RoomMemberCountResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetRoomMemberProfileSuccess {
    Status200(crate::models::RoomUserProfileResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetWebhookEndpointSuccess {
    Status200(crate::models::GetWebhookEndpointResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum IssueLinkTokenSuccess {
    Status200(crate::models::IssueLinkTokenResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum PushMessageSuccess {
    Status200(crate::models::PushMessageResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum ReplyMessageSuccess {
    Status200(crate::models::ReplyMessageResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum TestWebhookEndpointSuccess {
    Status200(crate::models::TestWebhookEndpointResponse),
    UnknownValue(serde_json::Value),
}
...
pub async fn delete_rich_menu(
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        richMenuId = crate::apis::urlencode(rich_menu_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_rich_menu_alias(
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        richMenuAliasId = crate::apis::urlencode(rich_menu_alias_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
