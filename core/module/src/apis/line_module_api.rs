...
pub struct AcquireChatControlParams {
    ...
    pub chat_id: String,
    pub acquire_chat_control_request: Option<crate::models::AcquireChatControlRequest>,
}

/// struct for passing parameters to the method [`detach_module`]
#[derive(Clone, Debug)]
pub struct DetachModuleParams {
    pub detach_module_request: Option<crate::models::DetachModuleRequest>,
}
...
pub enum GetModulesSuccess {
    Status200(crate::models::GetModulesResponse),
    UnknownValue(serde_json::Value),
}
...
pub async fn acquire_chat_control(
    ...
    let local_var_uri_str = format!(
        ...
        chatId = crate::apis::urlencode(chat_id)
    );
