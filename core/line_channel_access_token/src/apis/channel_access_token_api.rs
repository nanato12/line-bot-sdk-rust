...
client_id: &str,
client_secret: &str,
) -> Pin<Box<dyn Future<Output = Result<models::IssueShortLivedChannelAccessTokenResponse, Error>> + Send>>;
...
) -> Pin<Box<dyn Future<Output = Result<models::IssueStatelessChannelAccessTokenResponse, Error>> + Send>>;
