...
impl<C: hyper::client::connect::Connect> ChannelAccessTokenApiClient<C>
    ...
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> ChannelAccessTokenApiClient<C> {
...
pub trait ChannelAccessTokenApi {
    fn gets_all_valid_channel_access_token_key_ids(&self, client_assertion_type: &str, client_assertion: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::ChannelAccessTokenKeyIdsResponse, Error>>>>;
    fn issue_channel_token(&self, grant_type: Option<&str>, client_id: Option<&str>, client_secret: Option<&str>) -> Pin<Box<dyn Future<Output = Result<crate::models::IssueShortLivedChannelAccessTokenResponse, Error>>>>;
    fn issue_channel_token_by_jwt(&self, grant_type: Option<&str>, client_assertion_type: Option<&str>, client_assertion: Option<&str>) -> Pin<Box<dyn Future<Output = Result<crate::models::IssueChannelAccessTokenResponse, Error>>>>;
    fn issue_stateless_channel_token(&self, grant_type: Option<&str>, client_assertion_type: Option<&str>, client_assertion: Option<&str>, client_id: Option<&str>, client_secret: Option<&str>) -> Pin<Box<dyn Future<Output = Result<crate::models::IssueStatelessChannelAccessTokenResponse, Error>>>>;
    fn revoke_channel_token(&self, access_token: Option<&str>) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn revoke_channel_token_by_jwt(&self, client_id: Option<&str>, client_secret: Option<&str>, access_token: Option<&str>) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn verify_channel_token(&self, access_token: Option<&str>) -> Pin<Box<dyn Future<Output = Result<crate::models::VerifyChannelAccessTokenResponse, Error>>>>;
    fn verify_channel_token_by_jwt(&self, access_token: &str) -> Pin<Box<dyn Future<Output = Result<crate::models::VerifyChannelAccessTokenResponse, Error>>>>;
}
