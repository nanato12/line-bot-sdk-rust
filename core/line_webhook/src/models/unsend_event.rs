...
pub struct UnsendEvent {
    ...
    #[serde(rename = "unsend")]
    pub unsend: Box<crate::models::UnsendDetail>,
}

impl UnsendEvent {
    /// Event object for when the user unsends a message.
    pub fn new(timestamp: i64, mode: crate::models::EventMode, webhook_event_id: String, delivery_context: crate::models::DeliveryContext, unsend: crate::models::UnsendDetail) -> UnsendEvent {
        UnsendEvent {
