...
pub fn new(timestamp: i64, mode: models::EventMode, webhook_event_id: String, delivery_context: models::DeliveryContext, link: models::LinkContent) -> AccountLinkEvent {
        AccountLinkEvent {
source: None,
timestamp,
mode,
