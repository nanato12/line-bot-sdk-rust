...
pub struct AccountLinkEvent {
    ...
    #[serde(rename = "link")]
    pub link: Box<crate::models::LinkContent>,
}
...
impl AccountLinkEvent {
    ...
    pub fn new(timestamp: i64, mode: crate::models::EventMode, webhook_event_id: String, delivery_context: crate::models::DeliveryContext, link: crate::models::LinkContent) -> AccountLinkEvent {
        AccountLinkEvent {
