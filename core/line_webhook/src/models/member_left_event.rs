...
pub struct MemberLeftEvent {
    ...
    #[serde(rename = "left")]
    pub left: Box<crate::models::LeftMembers>,
}
...
impl MemberLeftEvent {
    ...
    pub fn new(timestamp: i64, mode: crate::models::EventMode, webhook_event_id: String, delivery_context: crate::models::DeliveryContext, left: crate::models::LeftMembers) -> MemberLeftEvent {
        MemberLeftEvent {
