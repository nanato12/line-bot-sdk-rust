...
pub struct ThingsEvent {
    ...
    #[serde(rename = "things")]
    pub things: Box<crate::models::ThingsContent>,
}

impl ThingsEvent {
    /// Indicates that a user linked a device with LINE.
    pub fn new(timestamp: i64, mode: crate::models::EventMode, webhook_event_id: String, delivery_context: crate::models::DeliveryContext, reply_token: String, things: crate::models::ThingsContent) -> ThingsEvent {
        ThingsEvent {
