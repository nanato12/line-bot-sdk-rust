...
impl MessageEvent {
    ...
    pub fn new(timestamp: i64, mode: crate::models::EventMode, webhook_event_id: String, delivery_context: crate::models::DeliveryContext, message: crate::models::MessageContent) -> MessageEvent {
        MessageEvent {
