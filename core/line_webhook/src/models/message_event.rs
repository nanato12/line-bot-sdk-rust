...
pub fn new(timestamp: i64, mode: models::EventMode, webhook_event_id: String, delivery_context: models::DeliveryContext, message: models::MessageContent) -> MessageEvent {
        MessageEvent {
source: None,
timestamp,
mode,
