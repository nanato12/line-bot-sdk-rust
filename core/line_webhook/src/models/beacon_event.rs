...
pub fn new(timestamp: i64, mode: models::EventMode, webhook_event_id: String, delivery_context: models::DeliveryContext, reply_token: String, beacon: models::BeaconContent) -> BeaconEvent {
        BeaconEvent {
source: None,
timestamp,
mode,
