...
pub struct BeaconEvent {
    ...
    #[serde(rename = "beacon")]
    pub beacon: Box<crate::models::BeaconContent>,
}

impl BeaconEvent {
    /// Event object for when a user enters the range of a LINE Beacon. You can reply to beacon events.
    pub fn new(timestamp: i64, mode: crate::models::EventMode, webhook_event_id: String, delivery_context: crate::models::DeliveryContext, reply_token: String, beacon: crate::models::BeaconContent) -> BeaconEvent {
        BeaconEvent {
