...
pub struct VideoPlayCompleteEvent {
    ...
    pub video_play_complete: Box<crate::models::VideoPlayComplete>,
}
...
impl VideoPlayCompleteEvent {
    ...
    pub fn new(timestamp: i64, mode: crate::models::EventMode, webhook_event_id: String, delivery_context: crate::models::DeliveryContext, reply_token: String, video_play_complete: crate::models::VideoPlayComplete) -> VideoPlayCompleteEvent {
