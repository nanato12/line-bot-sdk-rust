...
pub struct ImageMessageContent {
    ...
    pub image_set: Option<Box<crate::models::ImageSet>>,
...
impl ImageMessageContent {
    pub fn new(id: String, content_provider: crate::models::ContentProvider, quote_token: String) -> ImageMessageContent {
        ImageMessageContent {
