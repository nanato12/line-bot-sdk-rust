...
pub fn new(timestamp: i64, mode: models::EventMode, webhook_event_id: String, delivery_context: models::DeliveryContext, reply_token: String, membership: models::MembershipContent) -> MembershipEvent {
        MembershipEvent {
source: None,
timestamp,
mode,
