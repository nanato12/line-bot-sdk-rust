...
pub struct ModuleEvent {
    ...
    #[serde(rename = "module")]
    pub module: Box<crate::models::ModuleContent>,
}
...
impl ModuleEvent {
    ...
    pub fn new(timestamp: i64, mode: crate::models::EventMode, webhook_event_id: String, delivery_context: crate::models::DeliveryContext, module: crate::models::ModuleContent) -> ModuleEvent {
        ModuleEvent {
