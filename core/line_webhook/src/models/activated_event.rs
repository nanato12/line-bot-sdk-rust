...
pub struct ActivatedEvent {
    ...
    pub chat_control: Box<crate::models::ChatControl>,
}
...
impl ActivatedEvent {
    ...
    pub fn new(timestamp: i64, mode: crate::models::EventMode, webhook_event_id: String, delivery_context: crate::models::DeliveryContext, chat_control: crate::models::ChatControl) -> ActivatedEvent {
        ActivatedEvent {
