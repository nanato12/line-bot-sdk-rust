...
/// GetRichMenuInsightSummaryResponse : Summary of impression and click statistics for a rich menu created via the Messaging API.
...
pub struct GetRichMenuInsightSummaryResponse {
    ...
    pub impression: Option<Box<models::GetRichMenuInsightSummaryResponseImpression>>,
    /// Click metrics for each tappable area of the rich menu.
    #[serde(rename = "clicks", skip_serializing_if = "Option::is_none")]
    pub clicks: Option<Vec<models::GetRichMenuInsightSummaryResponseClick>>,
}

impl GetRichMenuInsightSummaryResponse {
    /// Summary of impression and click statistics for a rich menu created via the Messaging API.
    pub fn new(rich_menu_id: String) -> GetRichMenuInsightSummaryResponse {
