...
pub enum GetsAllValidChannelAccessTokenKeyIdsSuccess {
    Status200(crate::models::ChannelAccessTokenKeyIdsResponse),
...
pub enum IssueChannelTokenSuccess {
    Status200(crate::models::IssueShortLivedChannelAccessTokenResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum IssueChannelTokenByJwtSuccess {
    Status200(crate::models::IssueChannelAccessTokenResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum IssueStatelessChannelTokenSuccess {
    Status200(crate::models::IssueStatelessChannelAccessTokenResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum VerifyChannelTokenSuccess {
    Status200(crate::models::VerifyChannelAccessTokenResponse),
    UnknownValue(serde_json::Value),
}
...
> {
    ...
    local_var_req_builder = local_var_req_builder
        .query(&[("client_assertion_type", &client_assertion_type.to_string())]);
    local_var_req_builder =
        local_var_req_builder.query(&[("client_assertion", &client_assertion.to_string())]);
