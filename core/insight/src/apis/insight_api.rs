...
pub enum GetFriendsDemographicsSuccess {
    Status200(crate::models::GetFriendsDemographicsResponse),
...
pub enum GetMessageEventSuccess {
    Status200(crate::models::GetMessageEventResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetNumberOfFollowersSuccess {
    Status200(crate::models::GetNumberOfFollowersResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetNumberOfMessageDeliveriesSuccess {
    Status200(crate::models::GetNumberOfMessageDeliveriesResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GetStatisticsPerUnitSuccess {
    Status200(crate::models::GetStatisticsPerUnitResponse),
    UnknownValue(serde_json::Value),
}
